...
// // Định nghĩa thư mục lưu ảnh cố định
// const folderPath = path.join(__dirname, "../public/image/tour"); // Cập nhật đường dẫn đúng
// // Tạo thư mục nếu chưa tồn tại
// if (!fs.existsSync(folderPath)) {
//     fs.mkdirSync(folderPath, { recursive: true });
// }
...
// const storage = multer.diskStorage({
//     destination: function (req, file, cb) {
//         cb(null, folderPath); // Lưu file vào thư mục cố định
//     },
//     filename: function (req, file, cb) {
//         cb(null, Date.now() + path.extname(file.originalname)); // Đổi tên file để tránh trùng lặp
//     }
